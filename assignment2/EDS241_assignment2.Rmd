...
librarian::shelf("stargazer", "here", "tidyr", "dplyr","stringr", "janitor", 
           ...
           "patchwork", "estimatr", "car", "xtable", "readxl")
...
\noindent The coefficient on `nbp` represents the difference in change in NOx in counties with and without `nbp` in effect that have `pct_black` lower than the median.

\noindent The coefficient on `D` represents the difference in change in NOx in counties without `nbp` in effect with `pct_black` higher than median and `pct_black` lower than median.

\noindent The coefficient on the interaction between `nbp` and `D` represents the difference in effect on NOx of `nbp` in counties with `pct_black` higher than median and counties with `pct_black` lower than median. 
